...
parser.add_argument(
    '-f', '--file_index', help='file index for the data split .', type=int)
parser.add_argument(
...
def random_sample():
  ...
  if not os.path.exists(os.path.join(args.data_path, 'random_sample')):
    os.makedirs(os.path.join(args.data_path, 'random_sample'))
  file_labelled = os.path.join(args.data_path, 'random_sample',
